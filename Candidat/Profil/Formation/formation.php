...
<body>
    ...
    <div class="body">
        <h1>Ajouter Une Formation</h1><br>
        ...
        <div>
            <label class="label">École *</label><br>
            <input class="input" type="text">
        </div><br>
        <div>
            <label class="label">Domaine *</label><br>
            <input class="input" type="text">
        </div><br>
        <div>
        ...
        <div class="checkbox">
            <input type="checkbox" id="actual">
            <label class="label" for="actual">J'étudie actuellement ici</label>
        </div><br>
        <div>
