<?php
    ...
    $query = $conn->prepare("SELECT email FROM personne,candidat WHERE personne.email=candidat.email_candidat AND email!=:email AND domaine LIKE :this");
    $query->bindParam(':email',$email);
    $query->bindParam(':this',$searching);
    $query->execute();
?>
<!DOCTYPE html>
<html lang="en">
...
<body>
    ...
    <h3 class="result-search">Résultats de recherche pour <span style="color: blue;"><?php echo $search ?></span></h3>
    <div class="row">
