<?php
    ...
    $poste = $conn->prepare("SELECT * FROM poste,favourite WHERE poste.id_poste = favourite.id_poste AND favourite.email_candidat = :email ORDER BY date_fav DESC");
...
<body>
    ...
    <div class="nav2">
        <div>
            ...
            <a href="#" id="theone"><i class="fa-solid fa-heart"></i> <span>Mes offres</span></a>
            <a href="#"><i class="fa-solid fa-gear"></i> <span>Paramètres</span></a>
        </div>
    </div>
    <h3 class="result-search" style="color: blue;">Mes Offres</span></h3>
    <div class="row">
